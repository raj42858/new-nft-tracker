...
import { Search, Plus, Trash2, Upload, X, Flag, Zap, Moon, ExternalLink, ChevronLeft, LayoutGrid, List, RefreshCw, Loader2, Eye } from 'lucide-react';
        ...
        {selected ? (
          <>
            ...
            <div className="h-11 flex items-center gap-2 px-4 border-b border-[#1a1a1a] bg-[#0a0a0a] flex-shrink-0">
              ...
              <div className="flex bg-[#111] rounded-lg p-0.5">
                <button onClick={() => setView('grid')} className={`p-1.5 rounded-md ${view === 'grid' ? 'bg-white text-black' : 'text-neutral-500'}`}><LayoutGrid size={14} /></button>
